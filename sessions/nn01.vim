...
inoremap <silent> <Plug>delimitMate{ {=delimitMate#ParenDelim("}")
inoremap <silent> <Plug>delimitMate( (=delimitMate#ParenDelim(")")
imap <F1> jj :NERDTreeToggle
imap <F2> jj :GundoToggle
...
nnoremap ,re :call NumberToggle()
nnoremap ,L I
nnoremap ,l A
nmap ,c :inoremap <Space> <Space><Esc>:iunmap <lt>Space><CR> cw
...
silent only
cd ~/Documents/stage2015/CppProjects/NeuralNetwork05
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 main.cpp
badd +6 ~/Documents/stage2015/Pythons/showInputOutputTarget.py
args .
edit main.cpp
...
1
normal! 0
tabedit ~/Documents/stage2015/Pythons/showInputOutputTarget.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
